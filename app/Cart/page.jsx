  ...
  <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
    <div className="mx-auto max-w-3xl">
      ...
      <div className="mt-8">
          ...
          {cart?.map((ct,i)=>{
            ...
            <div className="flex flex-1 items-center justify-end gap-2">
              <form>
                ...
                <h1 className='font-medium text-[20px] '>{ct?.product?.attributes?.price} $</h1>
              </form>

              <button onClick={()=>{DltCrtItm(ct?.id)}} className="text-gray-600 transition hover:text-red-600">
        ...
        <h2 className='text-gray-300 text-[15px] '>Note : All Items will be sent via Email</h2>
      </div>
    </div>
  </div>
</section>
